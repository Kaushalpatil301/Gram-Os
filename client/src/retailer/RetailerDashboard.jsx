...
const NAV_ITEMS = [
  {
    id: "browse",
    labelKey: "retailer.nav.browse",
    icon: Package,
    color: "text-emerald-600",
  },
  {
    id: "analytics",
    labelKey: "retailer.nav.analytics",
    icon: BarChart3,
    color: "text-blue-600",
  },
  {
    id: "network",
    labelKey: "retailer.nav.network",
    icon: Users,
    color: "text-orange-600",
  },
  {
    id: "workforce",
    labelKey: "retailer.nav.workforce",
    icon: Users,
    color: "text-orange-600",
  },
  {
    id: "contracts",
    labelKey: "retailer.nav.contracts",
    icon: FileText,
    color: "text-purple-600",
  },
  {
    id: "credit",
    labelKey: "retailer.nav.credit",
    icon: Award,
    color: "text-amber-600",
  },
  {
    id: "loans",
    labelKey: "retailer.nav.loans",
    icon: DollarSign,
    color: "text-blue-600",
  },
  {
    id: "schemes",
    labelKey: "retailer.nav.schemes",
    icon: Landmark,
    color: "text-indigo-600",
  },
  {
    id: "qr",
    labelKey: "retailer.nav.qr",
    icon: QrCode,
    color: "text-emerald-600",
  },
];
...
function RetailerDashboardContent() {
  ...
  const [notifications, setNotifications] = useState([
    {
      ...
      topic: t("notifications.topic.orderAccepted", {
        qty: 500,
        unit: "kg",
    ...
    },
    {
      ...
      topic: t("notifications.topic.jobAccepted", {
        job: "Warehouse Sorting",
      }),
    },
  ]);
  ...
  const handleAcceptConnect = (notif) => {
    ...
    showNotificationToast(t("retailer.notifications.connected"));
    goTo("chat");
  };
      ...
      >
        ...
        <div className="border-t border-gray-100 p-4">
          ...
          >
            ...
            <span className="truncate">{t("retailer.profile.admin")}</span>
          </button>
                        ...
                        <div className="flex gap-3">
                          ...
                          <div>
                            <p className="text-sm font-medium text-gray-900">
                              {notif.type === "order_accepted"
                                ? t("retailer.notifications.farmerAccepted", {
                                    name: notif.farmerName,
                                  })
                                : t("retailer.notifications.workerAccepted", {
                                    name: notif.workerName,
                                  })}
                            </p>
                            ...
                            <div className="flex gap-2 mt-3">
                              {notif.type === "order_accepted" ? (
                                ...
                                >
                                  {t("retailer.notifications.viewOrder")}
                                </button>
                              ) : (
                                <button
                                  onClick={() => {
                                ...
                                >
                                  {t("retailer.notifications.viewJob")}
                                </button>
                              )}
                            </div>
                          </div>

...
export default function Contracts() {
  ...
  useEffect(() => {
    const selectedFarmer = farmers.find(
      (f) =>
        ...
        contractForm.farmer.toLowerCase().replace(/\s+/g, ""),
    );
    ...
    setLivePreview({
      ...
      isComplete:
        contractForm.farmer &&
        contractForm.produce &&
        contractForm.quantity &&
        contractForm.unit &&
        contractForm.pricePerUnit &&
  ...
  const handleCreateContract = () => {
    ...
    const totalValue =
      parseFloat(contractForm.quantity) * parseFloat(contractForm.pricePerUnit);
    ...
    >
      <div className="p-6 md:p-10">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 md:gap-8 mb-6 md:mb-10">
                ...
                >
                  ...
                  <SelectContent>
                    {farmers.map((farmer) => (
                      <SelectItem
                        key={farmer.id}
                        value={farmer.name.toLowerCase().replace(/\s+/g, "")}
                      >
          ...
          {/* Live Preview */}
          <Card
            className={`border-0 shadow-sm ${livePreview.isComplete ? "ring-2 ring-green-100" : ""}`}
          >
            <CardHeader className="pb-3 md:pb-4 px-4 md:px-6">
                  ...
                  {contractsData.map((contract) => (
                    <tr key={contract.id} className="hover:bg-gray-50">
                      <td className="px-4 lg:px-6 py-4">
                        <code className="text-xs lg:text-sm text-gray-800">
                          {contract.id}
                        </code>
                      </td>
                      ...
                      <td className="px-4 lg:px-6 py-4 text-gray-700 hidden lg:table-cell">
                        {contract.quantity}
                      </td>
                      <td className="px-4 lg:px-6 py-4">

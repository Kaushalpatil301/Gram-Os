        ...
        <div className="w-2/3 flex flex-col bg-slate-50 border-r border-gray-100">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-4">
            ...
            {currentMessages.map((msg, i) => (
              ...
              >
                <div
                  className={`max-w-[75%] rounded-2xl px-4 py-3 shadow-sm ${msg.sender === "Retailer" ? "bg-emerald-600 text-white rounded-tr-sm" : "bg-white border border-gray-100 text-gray-800 rounded-tl-sm"}`}
                >
                  <p className="text-sm font-medium leading-relaxed">
                    {msg.text}
                  </p>
                  <p
                    className={`text-[10px] mt-1.5 text-right font-medium ${msg.sender === "Retailer" ? "text-emerald-100" : "text-gray-400"}`}
                  >
                    {msg.time}
                  </p>
                </div>

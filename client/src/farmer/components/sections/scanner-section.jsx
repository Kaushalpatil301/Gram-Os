    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold text-gray-900 mb-3">
          {t("farmer.scanner.title")}
        </h2>
        <p className="text-gray-600">
          {t("farmer.scanner.subtitle")}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader>
            <CardTitle className="text-center">{t("farmer.scanner.scanProduct")}</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="bg-white rounded-2xl border-2 border-green-200 p-8 text-center hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                {t("farmer.scanner.productScanner")}
                
              </h3>
              <p className="text-gray-600 mb-8">
                {t("farmer.scanner.cardSubtitle")}
              </p>
              <button
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <CardTitle>{t("farmer.scanner.recentScans")}</CardTitle>
              </div>
              <span className="text-sm text-gray-500">
                {scanHistory.length} {t("farmer.scanner.total")}
              </span>
            </div>
          </CardHeader>
          <CardContent>
